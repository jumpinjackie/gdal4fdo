...
!IFNDEF NO_BUILD
!IFDEF WIN64
    rem nmake gdal-python GDAL_DIR=$(GDAL_DIR) PYTHON_DIR=Python34-AMD64
    rem nmake gdal-python-bdist GDAL_DIR=$(GDAL_DIR) PYTHON_DIR=Python34-AMD64
...
!ELSE
    rem nmake gdal-python GDAL_DIR=$(GDAL_DIR) PYTHON_DIR=Python34
    rem nmake gdal-python-bdist GDAL_DIR=$(GDAL_DIR) PYTHON_DIR=Python34
